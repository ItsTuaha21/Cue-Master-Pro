...
export const Navbar: React.FC = () => {
  ...
  return (
    <header className="bg-[#0b120f] border-b border-emerald-900/25 text-white sticky top-0 z-40 px-4 py-2.5 flex items-center justify-between shadow-xl shadow-black/40 backdrop-blur-md">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] px-2 py-0.5 rounded-full bg-emerald-950/70 text-emerald-400 border border-emerald-800/50 font-bold uppercase tracking-wider">
              Club SaaS
            </span>
          </div>
          <div className="flex items-center gap-1.5 text-xs text-slate-400">
            <Building2 className="w-3 h-3 text-emerald-400/80" />
            <span className="truncate max-w-[170px] sm:max-w-xs">{settings.club_name}</span>
          </div>
        </div>
      </div>
      ...
      {/* Right Controls: Role Context & Profile */}
      <div className="flex items-center gap-3">
        {/* Role Selector (Owner, Manager, Cashier) */}
        <div className="flex items-center bg-[#070b09] p-1 rounded-xl border border-emerald-900/30">
          <button
            ...
            title="Switch to Club Owner perspective"
          >
          ...
          <button
            ...
            title="Switch to Manager perspective"
          >
          ...
          <button
            ...
            title="Switch to Cashier / Floor perspective"
          >
        ...
        <div className="flex items-center gap-2 pl-2 border-l border-white/10">
          ...
          <div className="hidden sm:block text-left">
            <div className="text-xs font-bold text-white leading-tight">{currentUser.full_name}</div>
            <div className="text-[10px] text-amber-400/90 font-semibold tracking-wider">
